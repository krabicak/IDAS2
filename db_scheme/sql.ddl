...
ALTER TABLE formy ADD CONSTRAINT formy_pk PRIMARY KEY ( studijni_obor_id,
forma_vyuky_id );
...
CREATE TABLE predmet (
    ...
    zakonceni_predmetu_zkratka        NVARCHAR2(5) NOT NULL,
    kategorie_predmetu_zkratka        NVARCHAR2(5),
    doporuceny_rocnik_cislo_rocniku   INTEGER,
    pracovnici_id                     INTEGER NOT NULL
)
LOGGING;
...
ALTER TABLE sem ADD CONSTRAINT sem_pk PRIMARY KEY ( semestr_id,
predmet_id );
...
ALTER TABLE studini_plan ADD CONSTRAINT studini_plan_pk PRIMARY KEY ( studijni_obor_id,
predmet_id );
...
CREATE TABLE vyukova_akce (
    ...
    zpusob_vyuky_zkrata   NVARCHAR2(50) NOT NULL,
    pracovnici_id         INTEGER,
    pocatek               DATE,
    konec                 DATE,
    dny_zkratka           NVARCHAR2(5),
    predmet_id            INTEGER NOT NULL,
    ucebna_id             INTEGER,
    ucebna_oznaceni       VARCHAR2(50)
)
LOGGING;
...
ALTER TABLE formy
    ADD CONSTRAINT formy_forma_vyuky_fk FOREIGN KEY ( forma_vyuky_id )
        REFERENCES forma_vyuky ( id )
    NOT DEFERRABLE;

ALTER TABLE formy
    ADD CONSTRAINT formy_studijni_obor_fk FOREIGN KEY ( studijni_obor_id )
...
ALTER TABLE pracovnici
    ADD CONSTRAINT pracovnici_pracoviste_fk FOREIGN KEY ( pracoviste_id )
...
ALTER TABLE predmet
    ADD CONSTRAINT predmet_doporuceny_rocnik_fk FOREIGN KEY ( doporuceny_rocnik_cislo_rocniku )
...
ALTER TABLE predmet
    ADD CONSTRAINT predmet_pracovnici_fk FOREIGN KEY ( pracovnici_id )
...
ALTER TABLE sem
    ADD CONSTRAINT sem_predmet_fk FOREIGN KEY ( predmet_id )
        REFERENCES predmet ( id )
    NOT DEFERRABLE;

ALTER TABLE sem
    ADD CONSTRAINT sem_semestr_fk FOREIGN KEY ( semestr_id )
...
ALTER TABLE studini_plan
    ADD CONSTRAINT studini_plan_predmet_fk FOREIGN KEY ( predmet_id )
        REFERENCES predmet ( id )
    NOT DEFERRABLE;

ALTER TABLE studini_plan
    ADD CONSTRAINT studini_plan_studijni_obor_fk FOREIGN KEY ( studijni_obor_id )
        REFERENCES studijni_obor ( id )
    NOT DEFERRABLE;

ALTER TABLE vyukova_akce
    ADD CONSTRAINT vyukova_akce_dny_fk FOREIGN KEY ( dny_zkratka )
        REFERENCES dny ( zkratka )
    NOT DEFERRABLE;

ALTER TABLE vyukova_akce
    ADD CONSTRAINT vyukova_akce_pracovnici_fk FOREIGN KEY ( pracovnici_id )
        REFERENCES pracovnici ( id )
    NOT DEFERRABLE;
...
ALTER TABLE vyukova_akce
    ADD CONSTRAINT vyukova_akce_ucebna_fk FOREIGN KEY ( ucebna_oznaceni,
    ucebna_id )
